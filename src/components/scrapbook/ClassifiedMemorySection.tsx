...
import { Lock, Unlock, ShieldAlert, Sparkles, FileQuestion } from "lucide-react";
...
export const ClassifiedMemorySection: React.FC = () => {
  ...
  return (
    <section
      id="classified"
      className="py-16 sm:py-20 px-4 sm:px-6 relative max-w-3xl mx-auto"
    >
      {/* Chapter Marker */}
      <div className="flex items-center gap-3 mb-6">
        ...
        <PostageStamp date="CONFIDENTIAL" label="RESTRICTED" color="terracotta" />
      </div>

      {/* Sealed Classified Envelope / Card */}
      <div className="bg-[#FAF4EC] rounded-lg border-2 border-dashed border-[#DFCDB7] p-6 sm:p-8 relative shadow-sm text-center">
        ...
        <div className="max-w-md mx-auto space-y-4 pt-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-stone-900 text-amber-200 text-[11px] font-mono uppercase tracking-widest">
            ...
            <span>Top Secret • Eyes Only for Monica</span>
          </div>
          ...
          <p className="font-sans text-xs sm:text-sm text-[#6B635B] leading-relaxed">
            There’s one old prank / mistake that remains strictly sealed in the archives.
            No details, no files, and no public explanations here.
          </p>
          ...
          <div className="pt-2">
            {!isUnlocked ? (
              ...
              <div className="bg-white p-5 rounded-lg border border-[#EADBCE] shadow-sm text-left space-y-3 animate-fade-in">
                ...
                <p className="font-serif italic text-sm sm:text-base text-[#443F3A] leading-relaxed">
                  "You know exactly what this is about. I’m not putting any of it here. But... I’m genuinely sorry for that one. You’ve been extraordinarily gracious about it, and it won't ever happen again."
                </p>
                <p className="font-handwriting text-xs text-[#8C4A2F] text-right">
                  — Harshu
                </p>
              </div>
            )}
